...
if(isset($_GET['obrisi'])){
 ...
 $query = "DELETE FROM office_slike WHERE id = '{$del_id}' ";
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        if(isset($_POST['submit'])){
                             ...
                             $res = mysqli_query($connection, $query);
                             header("Location:office_slike.php");
                             }
                             ?>
                         ...
                         $query = "SELECT * FROM office_slike";
                             ...
                             while($row = mysqli_fetch_array($of_slike)){
                                 ...
                                 echo "<tr>";
                                    ...
                                    echo "<td><a href='office_slike.php?obrisi=$id' onclick='return myFunction()'>Obrisi</a><td>";
