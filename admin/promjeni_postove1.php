...
if(isset($_POST['update'])){
    ...
    $post_slike = $_FILES['slika']['name'];
    $post_tmp_name = $_FILES['slika']['tmp_name'];
  ...
  $query = "UPDATE postovi1 SET ";
    $query .= "naslov = '{$post_naslovi}', ";
    $query .= "tekst = '{$post_tekst}', ";
    $query .= "slika = '{$post_slike}' ";
    $query .= "WHERE  id = {$p_id}";
